...
namespace DynamicDescriptors.Tests.DynamicProperties
{
    public sealed class DynamicTypeDescriptorTests
    {
        ...
        {
            const string message = "parent should not be null. (Parameter 'parent')";
        ...
        public void GetProperties_SomePropertiesAreNotActive_ReturnsOnlyActiveProperties()
        {
            ...
            ConvertTo(properties).Should().HaveCount(2);
        ...
        private static PropertyDescriptor[] ConvertTo(PropertyDescriptorCollection properties)
        {
