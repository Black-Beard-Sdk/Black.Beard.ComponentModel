...
namespace DynamicDescriptors.Tests.DynamicProperties
{
    public sealed class Tests
    {
        ...
        public void Constructor_DataIsNull_ThrowsArgumentNullException()
        {
            ...
            act.Should().Throw<ArgumentNullException>().WithMessage("data should not be null. (Parameter 'data')");
        }
        ...
        public void Constructor_PropertyNameIsNull_ThrowsArgumentNullException()
        {
            ...
            act.Should().Throw<ArgumentNullException>().WithMessage("propertyName should not be null. (Parameter 'propertyName')");
        }
        ...
        public void Constructor_PropertyNameIsEmpty_ThrowsArgumentException()
        {
            ...
            act.Should().Throw<ArgumentException>().WithMessage("propertyName should not be an empty string. (Parameter 'propertyName')");
        }
        ...
        public void Constructor_PropertyTypeIsNull_ThrowsArgumentNullException()
        {
            ...
            act.Should().Throw<ArgumentNullException>().WithMessage("propertyType should not be null. (Parameter 'propertyType')");
        }
